...
const navIcons = [
  "dashboard", "analytics", "network", "group", "chat-bot", "recommend",
  "lightbulb", "anomaly", "document-chart", "filter", "information",
  "log-out", "checkmark-filled", "error-filled", "warning-alt",
  "arrow-up-right", "arrow-down-right",
];

export const BrandIcons = () => (
  <div className="fdn-brand-icons">
    <div className="fdn-head">
      <h1>Iconography — Shidoka Icon Library</h1>
      <p>
        Icons pulled from <code style={{ fontFamily: "var(--font-mono)", fontSize: "11px" }}>@kyndryl-design-system/shidoka-icons</code> (Shidoka Icon Library). Authored on a 32×32 grid with 2px padding; rendered via inline sprite so strokes follow <code style={{ fontFamily: "var(--font-mono)", fontSize: "11px" }}>currentColor</code>.
      </p>
    </div>

    <div className="fdn-section">
      <h2>Size scale · pairs with type</h2>
      <div className="fdn-icon-scale">
        <div className="fdn-scale-item"><Icon name="dashboard" size={14} /><span>14 · inline</span></div>
        <div className="fdn-scale-item"><Icon name="dashboard" size={16} /><span>16 · default</span></div>
        <div className="fdn-scale-item"><Icon name="dashboard" size={20} /><span>20 · heads</span></div>
        <div className="fdn-scale-item"><Icon name="dashboard" size={24} /><span>24 · toolbars</span></div>
        <div className="fdn-scale-item"><Icon name="dashboard" size={32} /><span>32 · feature</span></div>
        <div className="fdn-scale-item"><Icon name="dashboard" size={48} /><span>48 · empty state</span></div>
      </div>
    </div>

    <div className="fdn-section">
      <h2>Navigation &amp; product set · 17 icons</h2>
      <div className="fdn-icon-grid">
        {navIcons.map((name) => (
          <div key={name} className="fdn-ic">
            <Icon name={name} />
            <span>{name}</span>
          </div>
        ))}
    ...
    <div className="fdn-section">
      <h2>Tonal chips · icon + surface pairing</h2>
      <div className="fdn-chips">
        <span className="ki-chip"><Icon name="dashboard" /></span>
        <span className="fdn-chip-label">.ki-chip · neutral</span>
        <span className="ki-chip is-brand"><Icon name="recommend" /></span>
        <span className="fdn-chip-label">.ki-chip.is-brand · warm-red</span>
        <span className="ki-chip is-spruce"><Icon name="lightbulb" /></span>
        <span className="fdn-chip-label">.ki-chip.is-spruce</span>
      </div>
    </div>

    <div className="fdn-section">
      <h2>In‑context pairings</h2>
      <div style={{ display: "flex", gap: "18px", flexWrap: "wrap", alignItems: "center", padding: "14px 0" }}>
        <button
          style={{
            display: "inline-flex",
            alignItems: "center",
        ...
        >
          <Icon name="lightbulb" size={14} /> Investigate with AI
        </button>
        <span style={{ display: "inline-flex", alignItems: "center", gap: "6px", fontSize: "12px", color: "#047857" }}>
          <Icon name="arrow-up-right" size={14} /> +124 WoW
        </span>
        <span style={{ display: "inline-flex", alignItems: "center", gap: "6px", fontSize: "12px", color: "#B91C1C" }}>
          <Icon name="arrow-down-right" size={14} /> −4 pts
        </span>
        <span
          style={{
            display: "inline-flex",
        ...
        >
          <Icon name="warning-alt" size={14} /> 30d+ unreviewed
        </span>
        <span
          style={{
            display: "inline-flex",
        ...
        >
          <Icon name="checkmark-filled" size={14} /> Reconciled
        </span>
      </div>
    </div>

    <div className="fdn-notes">
      <strong>Load pattern.</strong> Include <code>&lt;script src="../assets/icons/ki.js" defer&gt;&lt;/script&gt;</code> once per page — the loader fetches <code>sprite.svg</code> and injects it at <code>&lt;body&gt;</code> start so <code>&lt;use href="#icon-…"/&gt;</code> resolves without CORS quirks on <code>file://</code>. Size with <code>.ki-14</code>/<code>.ki-16</code>/<code>.ki-20</code>/<code>.ki-24</code>/<code>.ki-32</code>/<code>.ki-48</code>; color via <code>currentColor</code>.
    </div>
  </div>
);
