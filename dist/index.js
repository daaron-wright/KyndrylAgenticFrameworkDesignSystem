...
var AgentStatusBar = ({
  ...
  return /* @__PURE__ */ jsxs8("div", { className: `ka-status ka-status--${stateClass} ${stateClass === "thinking" || stateClass === "streaming" ? "ka-edge" : ""}`, role: "status", "aria-live": "polite", children: [
    /* @__PURE__ */ jsx8("span", { className: "ka-status-dot" }),
    /* @__PURE__ */ jsx8("span", { className: "ka-status-label", children: label ?? copy.label }),
    /* @__PURE__ */ jsx8("span", { className: "ka-status-meta", children: meta ?? step ?? copy.meta }),
    /* @__PURE__ */ jsxs8("div", { className: "ka-status-controls", children: [
      (showStepThrough || onStepThroughChange) && /* @__PURE__ */ jsxs8("label", { className: "ka-status-step", children: [
        /* @__PURE__ */ jsx8("input", { type: "checkbox", checked: !!stepThrough, onChange: (event) => onStepThroughChange?.(event.target.checked) }),
        "Step-through"
      ] }),
      supportingAction && /* @__PURE__ */ jsx8("button", { className: `ka-button ${state === "done" ? "" : "ka-button-danger"}`, type: "button", onClick: onSecondary ?? onBranch, children: supportingAction }),
      mainAction && /* @__PURE__ */ jsx8(
        "button",
        {
...
var ToolCallCard = ({
  ...
  return /* @__PURE__ */ jsxs9("div", { className: `ka-tool ka-tool--${normalized} ka-edge ${destructive ? "ka-tool--destructive" : ""}`, children: [
    /* @__PURE__ */ jsxs9("div", { className: "ka-tool-head", children: [
      /* @__PURE__ */ jsx9("span", { className: "ka-tool-icon", "aria-hidden": "true", children: normalized === "ok" ? /* @__PURE__ */ jsx9(CheckIcon, {}) : normalized === "err" ? /* @__PURE__ */ jsx9(AlertIcon, {}) : /* @__PURE__ */ jsx9(CodeIcon, {}) }),
      /* @__PURE__ */ jsxs9("div", { children: [
        /* @__PURE__ */ jsxs9("div", { className: "ka-tool-title", children: [
          copy.title,
          " ",
          /* @__PURE__ */ jsx9("span", { className: "ka-tool-name", children: toolName }),
          normalized === "ok" && resultSummary ? ` - ${resultSummary}` : ""
        ] }),
        /* @__PURE__ */ jsx9("div", { className: "ka-tool-meta", children: bodyMeta })
      ] }),
      /* @__PURE__ */ jsxs9("div", { className: "ka-tool-status", children: [
        /* @__PURE__ */ jsx9("span", { className: "ka-tool-status-dot" }),
        copy.status
      ] })
    ] }),
    (isPending || normalized === "err") && /* @__PURE__ */ jsxs9("div", { className: "ka-tool-body", children: [
      isPending && /* @__PURE__ */ jsx9("pre", { className: "ka-tool-args", "aria-label": `${toolName} arguments`, children: Object.entries(args).map(([key, value], index) => /* @__PURE__ */ jsxs9(React2.Fragment, { children: [
        /* @__PURE__ */ jsx9("span", { className: "ka-tool-key", children: key }),
        ":",
        " ",
        /* @__PURE__ */ jsx9("span", { className: `${valueClass(value)} ${editableKeys.includes(key) ? "ka-tool-editable" : ""}`, children: formatValue(value) }),
        index < Object.keys(args).length - 1 ? "\n" : ""
      ] }, key)) }),
      /* @__PURE__ */ jsxs9("div", { className: "ka-tool-actions", children: [
        isPending ? /* @__PURE__ */ jsxs9(Fragment4, { children: [
          /* @__PURE__ */ jsxs9("button", { className: "ka-button ka-button-primary", type: "button", onClick: onApprove, children: [
            /* @__PURE__ */ jsx9(CheckIcon, {}),
            "Approve and run"
          ] }),
          /* @__PURE__ */ jsx9("button", { className: "ka-button", type: "button", onClick: onEditArgs, children: "Edit args" }),
          /* @__PURE__ */ jsx9("button", { className: "ka-button", type: "button", onClick: onReject, children: "Skip" })
        ] }) : /* @__PURE__ */ jsxs9(Fragment4, { children: [
          /* @__PURE__ */ jsx9("button", { className: "ka-button", type: "button", onClick: onRetry, children: "Retry as reviewer" }),
          /* @__PURE__ */ jsx9("button", { className: "ka-button", type: "button", onClick: onHandoff, children: "Hand off to admin" }),
          /* @__PURE__ */ jsx9("button", { className: "ka-button", type: "button", onClick: onReject, children: "Branch - readonly" })
        ] }),
        onApproveAll && isPending && /* @__PURE__ */ jsx9("button", { className: "ka-button", type: "button", onClick: onApproveAll, children: "Approve all" }),
        /* @__PURE__ */ jsx9("span", { className: "ka-tool-gate", children: gateLabel })
      ] })
    ] })
  ] });
};
var CodeIcon = () => /* @__PURE__ */ jsx9("svg", { viewBox: "0 0 24 24", fill: "none", stroke: "currentColor", strokeWidth: "2", "aria-hidden": "true", children: /* @__PURE__ */ jsx9("path", { d: "M16 18l6-6-6-6M8 6l-6 6 6 6" }) });
var CheckIcon = () => /* @__PURE__ */ jsx9("svg", { viewBox: "0 0 24 24", fill: "none", stroke: "currentColor", strokeWidth: "3", strokeLinecap: "round", "aria-hidden": "true", children: /* @__PURE__ */ jsx9("polyline", { points: "20 6 9 17 4 12" }) });
var AlertIcon = () => /* @__PURE__ */ jsxs9("svg", { viewBox: "0 0 24 24", fill: "none", stroke: "currentColor", strokeWidth: "2.4", "aria-hidden": "true", children: [
...
var HumanInputRequest = ({
  ...
  primaryOption,
  onChoose
}) => /* @__PURE__ */ jsxs10("div", { className: "ka-hir", role: "group", "aria-label": "Human input required", children: [
  /* @__PURE__ */ jsxs10("div", { className: "ka-hir-head", children: [
    /* @__PURE__ */ jsx10("span", { className: "ka-hir-glyph", "aria-hidden": "true", children: /* @__PURE__ */ jsx10(QuestionIcon, {}) }),
    /* @__PURE__ */ jsx10("span", { className: "ka-hir-agent", children: agent }),
    /* @__PURE__ */ jsx10("span", { className: "ka-hir-time", children: timestamp })
  ] }),
  /* @__PURE__ */ jsx10("p", { className: "ka-hir-question", children: question }),
  context && /* @__PURE__ */ jsx10("div", { className: "ka-hir-context", children: context }),
  /* @__PURE__ */ jsxs10("div", { className: "ka-hir-actions", children: [
    ...
    /* @__PURE__ */ jsx10("span", { className: "ka-hir-blocking", children: blockingLabel })
  ] })
] });
var QuestionIcon = () => /* @__PURE__ */ jsxs10("svg", { viewBox: "0 0 24 24", fill: "none", stroke: "currentColor", strokeWidth: "2.5", strokeLinecap: "round", "aria-hidden": "true", children: [
  /* @__PURE__ */ jsx10("circle", { cx: "12", cy: "12", r: "10" }),
  /* @__PURE__ */ jsx10("path", { d: "M9.09 9a3 3 0 0 1 5.83 1c0 2-3 3-3 3" }),
...
var HandoffCard = ({
  ...
  return /* @__PURE__ */ jsxs11("div", { children: [
    /* @__PURE__ */ jsxs11("div", { className: "ka-handoff ka-edge", children: [
      /* @__PURE__ */ jsx11(Party, { name: from, role: fromRole, kind: fromKind, initials: fromInitials }),
      /* @__PURE__ */ jsxs11("div", { className: "ka-handoff-arrow", children: [
        /* @__PURE__ */ jsx11("span", { className: "ka-handoff-reason", children: reason }),
        /* @__PURE__ */ jsxs11("svg", { className: "ka-handoff-line", viewBox: "0 0 200 10", preserveAspectRatio: "none", "aria-hidden": "true", children: [
          /* @__PURE__ */ jsx11("line", { x1: "0", y1: "5", x2: "194", y2: "5", stroke: "#475569", strokeWidth: "1", vectorEffect: "non-scaling-stroke" }),
          /* @__PURE__ */ jsx11("polyline", { points: "189,1 194,5 189,9", fill: "none", stroke: "#475569", strokeWidth: "1", strokeLinecap: "round", strokeLinejoin: "round", vectorEffect: "non-scaling-stroke" })
        ] }),
        /* @__PURE__ */ jsx11("span", { className: "ka-handoff-context", children: context })
      ] }),
      /* @__PURE__ */ jsx11(Party, { name: to, role: toRole ?? (resolvedToKind === "human" ? "CMDB owner" : "specialist agent"), kind: resolvedToKind, initials: toInitials })
    ] }),
    (showActions || onTrace || onAck) && /* @__PURE__ */ jsxs11("div", { className: "ka-handoff-actions", children: [
      /* @__PURE__ */ jsx11("button", { className: "ka-button", type: "button", onClick: onTrace, children: "View handoff trace" }),
      /* @__PURE__ */ jsx11("button", { className: "ka-button ka-button-primary", type: "button", onClick: onAck, children: "Accept and continue" })
    ] })
  ] });
};
var Party = ({ name, role, kind, initials: providedInitials }) => /* @__PURE__ */ jsxs11("div", { className: "ka-handoff-party", children: [
  /* @__PURE__ */ jsx11("div", { className: `ka-handoff-avatar ka-handoff-avatar--${kind}`, children: kind === "agent" ? /* @__PURE__ */ jsx11("span", { className: "ka-glyph" }) : providedInitials ?? initials(name) }),
  /* @__PURE__ */ jsx11("div", { className: "ka-handoff-name", children: name }),
  /* @__PURE__ */ jsx11("div", { className: "ka-handoff-role", children: role })
] });
...
var StateDeltaToast = ({
  ...
  return /* @__PURE__ */ jsxs12("div", { className: `ka-toast ${tone === "warm" ? "ka-toast--warm" : ""}`, role: "status", "aria-live": "polite", children: [
    /* @__PURE__ */ jsx12("div", { className: "ka-toast-glyph", "aria-hidden": "true", children: tone === "warm" ? /* @__PURE__ */ jsx12(CheckIcon2, {}) : /* @__PURE__ */ jsx12(PlusIcon, {}) }),
    /* @__PURE__ */ jsxs12("div", { className: "ka-toast-body", children: [
      "Agent updated ",
      /* @__PURE__ */ jsx12("strong", { children: subject ?? field }),
      /* @__PURE__ */ jsxs12("div", { className: "ka-toast-diff", children: [
        /* @__PURE__ */ jsx12("span", { className: "ka-toast-from", children: String(oldValue) }),
        /* @__PURE__ */ jsx12("span", { className: "ka-toast-arrow", children: "->" }),
        /* @__PURE__ */ jsx12("span", { className: "ka-toast-to", children: String(newValue) }),
        context && /* @__PURE__ */ jsxs12("span", { className: "ka-toast-context", children: [
          "- ",
          context
        ] })
      ] })
    ] }),
    /* @__PURE__ */ jsx12("div", { className: "ka-toast-actions", children: actionLabels.map((action) => /* @__PURE__ */ jsx12(
      "button",
      {
...
var PlusIcon = () => /* @__PURE__ */ jsx12("svg", { viewBox: "0 0 24 24", fill: "none", stroke: "currentColor", strokeWidth: "2.4", "aria-hidden": "true", children: /* @__PURE__ */ jsx12("path", { d: "M12 5v14M5 12h14" }) });
var CheckIcon2 = () => /* @__PURE__ */ jsx12("svg", { viewBox: "0 0 24 24", fill: "none", stroke: "currentColor", strokeWidth: "2.4", "aria-hidden": "true", children: /* @__PURE__ */ jsx12("polyline", { points: "6 12 10 16 18 8" }) });
...
var StepTimeline = ({
  ...
  onApproveOnce,
  onApproveAll
}) => /* @__PURE__ */ jsx13("div", { className: "ka-timeline", children: steps.map((step, index) => /* @__PURE__ */ jsxs13("div", { className: `ka-step ka-step--${step.state}`, children: [
  /* @__PURE__ */ jsx13("div", { className: "ka-step-rail", children: /* @__PURE__ */ jsx13("div", { className: "ka-step-marker" }) }),
  /* @__PURE__ */ jsxs13("div", { children: [
    /* @__PURE__ */ jsx13("div", { className: "ka-step-label", children: step.title }),
    step.note && /* @__PURE__ */ jsx13("div", { className: "ka-step-note", children: step.note }),
    step.state === "active" && showActiveControls && /* @__PURE__ */ jsxs13("div", { className: "ka-step-actions", children: [
      /* @__PURE__ */ jsx13("button", { className: "ka-button", type: "button", onClick: () => onEditStep?.(index), children: "Edit step" }),
      /* @__PURE__ */ jsx13("button", { className: "ka-button", type: "button", onClick: () => onApproveOnce?.(index), children: "Approve once" }),
      /* @__PURE__ */ jsx13("button", { className: "ka-button ka-button-primary", type: "button", onClick: onApproveAll, children: "Approve all" })
    ] })
  ] }),
  /* @__PURE__ */ jsx13("span", { className: "ka-step-time", children: step.timestamp ?? (step.state === "active" ? "running..." : step.state === "pending" ? "queued" : "") })
] }, `${step.title}-${index}`)) });
export {
  AgentStatusBar,
  AgenticMenu,
